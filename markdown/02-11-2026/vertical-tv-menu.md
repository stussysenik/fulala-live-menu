...
- Then design each page as a **vertical 1080×1920 CSS viewport** (DPR 2)—no CSS hacks like `transform: rotate()`.  
...
- Design each TV layout as a **portrait viewport** (1080×1920 CSS, DPR 2), exactly like a phone held upright—but with much larger typography. [webostv.developer.lge](https://webostv.developer.lge.com/develop/guides/stanbyme-portrait-mode)
